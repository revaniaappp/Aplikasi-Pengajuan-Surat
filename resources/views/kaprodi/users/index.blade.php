        ...
        <section class="panel mt-3">
            <div class="panel-header">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('kaprodi.users.index', ['role' => 'mahasiswa']) }}"
                        class="btn btn-sm {{ request('role') === 'mahasiswa' ? 'btn-primary' : 'btn-light' }}">Mahasiswa</a>
                    <a href="{{ route('kaprodi.users.index', ['role' => 'kaprodi']) }}"
                        class="btn btn-sm {{ request('role') === 'kaprodi' ? 'btn-primary' : 'btn-light' }}">Kaprodi</a>
                    <a href="{{ route('kaprodi.users.index', ['role' => 'tu']) }}"
                        class="btn btn-sm {{ request('role') === 'tu' ? 'btn-primary' : 'btn-light' }}">TU</a>
                </div>
            </div>
